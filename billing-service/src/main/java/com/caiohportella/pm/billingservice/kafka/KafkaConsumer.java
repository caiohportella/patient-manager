package com.caiohportella.pm.billingservice.kafka;
...
public class KafkaConsumer {
    ...
    public void consumeEvent(byte[] event) {
        try {
            ...
            log.info("Received billing account event from Kafka: [PatientId={}, PatientName={}, PatientEmail={}]",
            ...
            log.error("Error parsing BillingAccountEvent from Kafka: {}", e.getMessage(), e);
        }
    }
